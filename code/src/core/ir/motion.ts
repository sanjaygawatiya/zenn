...
export type MotionFingerprint = z.infer<typeof MotionFingerprintSchema>;
...
export type MotionProgramItem = z.infer<typeof MotionProgramItemSchema>;
...
export function validateMotionIR(json: unknown): Result<MotionIR> {
