...
export type AssetKeyframe = z.infer<typeof AssetKeyframeSchema>;
...
export type AssetRenderBlock = z.infer<typeof AssetRenderBlockSchema>;
...
export type CameraRenderBlock = z.infer<typeof CameraRenderBlockSchema>;
...
export function validateRenderIR(json: unknown): Result<RenderIR> {
